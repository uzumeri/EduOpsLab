...
- **Teaching Outside In** (Auburn University, College of Business, 2011–2012) — A two-semester supply chain course redesign using virtual practitioner interviews as the primary instructional frame. Using laptop, 4G, and video conferencing with no institutional IT support, regular sessions were organized with Fortune 100 executives, logistics managers, and supply chain specialists — some attended in person (Atlanta), the remainder were fully virtual. Theory was taught as annotation to practitioner experience rather than as the primary content. The key design insight: requesting an hour on a VP’s Outlook calendar is a qualitatively different ask from requesting a campus visit 100+ miles away. The initiative produced strong student engagement and was terminated by administrative decision after two semesters, nominally on accreditation grounds. Not published. → CP-7

---

*Last updated: 2026-04-20 — added CP-7 (practitioner authority, teaching outside in); added Teaching Outside In to Prior Work appendix; prior: HL-8, LP-4 show-your-work, HL-7, CM-5*
