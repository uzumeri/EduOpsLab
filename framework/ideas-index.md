...
# ideas.md — Entry Index

*Auto-generated index of all sections, subsections, and entry IDs in `ideas.md`. Each entry ID links back to the canonical document.*
...
| ES-2 | The apprenticeship model breaks at scale for the same reason |
| ES-3 | The library decouples expert production from expert delivery |
...
- Learning and Forgetting in Cross-Training (Chrysler / JOM)
- iPOV Inc.
- ADEEPERVIEW Tracking System
- Test-Free Student Assessment
- Technical eLearning Development Process
- Management System Metastandards
- Teaching Outside In
- DeeperPoint Inc. — Education Thin Markets
