...
The narrative arc, editorial principles, and known content gaps for `framework/ideas.md` and any derived ebook are in [`framework/editorial-brief.md`](framework/editorial-brief.md). This brief governs *what* to write; CLAUDE.md governs *how* to manage the files.
